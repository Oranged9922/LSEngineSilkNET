...
using LSSilkEngine.Common;

namespace IntroductionAbstraction
{
    class Program
    {
        ...
        private static LSSilkEngine.Common.Shader? Shader;
        ...
        private static void OnLoad()
        {
            ...
            Shader = new LSSilkEngine.Common.Shader(Gl, "Shaders/vertShader.glsl", "Shaders/fragShader.glsl");
        }
